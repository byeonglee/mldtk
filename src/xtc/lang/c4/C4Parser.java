...
// on Wednesday, February 23, 2011 at 2:21:04 PM.
 ...
 * generator, version 1.15.0, (C) 2004-2009 Robert Grimm.
 */
public final class C4Parser extends ParserBase {
  ...
  static final class Chunk2 {
    ...
    Result fLocalLabelDeclaration$$Star1;
  ...
  static final class C4ParserColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public C4Parser(final Reader reader, final String file) {
    super(reader, file);
   ...
   */
  public C4Parser(final Reader reader, final String file, final int size) {
  ...
  private Result pFunctionDefinition(final int yyStart) throws IOException {
    C4ParserColumn yyColumn = (C4ParserColumn)column(yyStart);
  ...
  private Result pCompoundStatement$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue("{")) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pLocalLabelDeclarationStar(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Pair<Node> v$g$1 = yyResult.semanticValue();
  ...
  private Result pLocalLabelDeclaration$1(final int yyStart) 
    ...
    if (yyResult.hasValue("__label__")) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pLocalLabelDeclaration$$Star1(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal xtc.lang.c4.C4.LocalLabelDeclaration$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pLocalLabelDeclaration$$Star1(final int yyStart) 
    throws IOException {

    C4ParserColumn yyColumn = (C4ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fLocalLabelDeclaration$$Star1) 
      yyColumn.chunk2.fLocalLabelDeclaration$$Star1 = pLocalLabelDeclaration$$Star1$1(yyStart);
    return yyColumn.chunk2.fLocalLabelDeclaration$$Star1;
  }

  /** Actually parse xtc.lang.c4.C4.LocalLabelDeclaration$$Star1. */
  private Result pLocalLabelDeclaration$$Star1$1(final int yyStart) 
    throws IOException {
  ...
  private Result pCommaExpression(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fCommaExpression) 
      yyColumn.chunk3.fCommaExpression = pCommaExpression$1(yyStart);
    return yyColumn.chunk3.fCommaExpression;
  }
  ...
  private Result pAssemblyOperands$$Star1(final int yyStart) 
    ...
    if (null == yyColumn.chunk4.fAssemblyOperands$$Star1) 
      yyColumn.chunk4.fAssemblyOperands$$Star1 = pAssemblyOperands$$Star1$1(yyStart);
    return yyColumn.chunk4.fAssemblyOperands$$Star1;
  }
  ...
  public Result pGlobalIntroductionAdvice(final int yyStart) 
    ...
    yyResult = pKeyword(yyStart);
    if (yyResult.hasValue("advice_intro")) {
      final String v$g$1 = "advice_intro";
      ...
      if (yyResult.hasValue("(")) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final String aName = yyResult.semanticValue();
                  ...
                  if (yyResult.hasValue("}")) {
                    ...
                    if (yyResult.hasValue(";")) {
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        yyValue = GNode.create("GlobalIntroductionAdvice", v$g$2.size() + 2).
                          add(v$g$1).add(aName).addAll(v$g$2);
                        yyValue.setLocation(location(yyStart));
                ...
                if (yyResult.hasValue()) {
                  ...
                  if (yyResult.hasValue("}")) {
                    ...
                    if (yyResult.hasValue()) {
                      ...
                      yyValue = GNode.create("StructureAdviceDeclaration", v$g$1, aName, v$g$2);
                      yyValue.setLocation(location(yyStart));
  ...
  private Result pBeforeAdviceStatement(final int yyStart) 
    ...
    yyResult = pKeyword(yyStart);
    if (yyResult.hasValue("advice_before")) {
      final String v$g$1 = "advice_before";
      ...
      if (yyResult.hasValue("(")) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final String adviceName = yyResult.semanticValue();
                  ...
                  if (yyResult.hasValue("}")) {
                    ...
                    if (yyResult.hasValue(";")) {
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        yyValue = GNode.create("BeforeAdviceStatement", v$g$2.size() + 2).
                          add(v$g$1).add(adviceName).addAll(v$g$2);
                        yyValue.setLocation(location(yyStart));
  ...
  private Result pAfterAdviceStatement(final int yyStart) throws IOException {
    ...
    yyResult = pKeyword(yyStart);
    if (yyResult.hasValue("advice_after")) {
      final String v$g$1 = "advice_after";
                  ...
                  if (yyResult.hasValue("}")) {
                    ...
                    if (yyResult.hasValue(";")) {
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        yyValue = GNode.create("AfterAdviceStatement", v$g$2.size() + 2).
                          add(v$g$1).add(adviceName).addAll(v$g$2);
                        yyValue.setLocation(location(yyStart));
  ...
  private Result pAroundAdviceStatement(final int yyStart) 
    ...
    yyResult = pKeyword(yyStart);
    if (yyResult.hasValue("advice_around")) {
      final String v$g$1 = "advice_around";
                  ...
                  if (yyResult.hasValue("}")) {
                    ...
                    if (yyResult.hasValue(";")) {
                      ...
                      if (yyResult.hasValue()) {
                        ...
                        yyValue = GNode.create("AroundAdviceStatement", v$g$2.size() + 2).
                          add(v$g$1).add(adviceName).addAll(v$g$2);
                        yyValue.setLocation(location(yyStart));
    ...
    if ((null == args) || (0 == args.length)) {
      ...
      for (int i=0; i<args.length; i++) {
        ...
        try {
          ...
          C4Parser p  = 
            new C4Parser(in, args[i], (int)new File(args[i]).length());
