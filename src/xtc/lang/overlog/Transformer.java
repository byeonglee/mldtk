...
// =========================================================================
  ...
  private Node makeSkeleton() {
    ...
    compUnit.add(
      GNode.create("ImportDeclaration", null,
                   GNode.create("QualifiedIdentifier", "xtc", "lang", "overlog", "runtime", "*"),
         null));
    return compUnit;
  }
  ...
  private void addImportsToTupleClass(Node javaAST) {
    javaAST.add(
      GNode.create("ImportDeclaration", null,
                   GNode.create("QualifiedIdentifier", "xtc", "lang", "overlog", "runtime", "Tuple"),
        null));
    javaAST.add(
      GNode.create("ImportDeclaration", null,
        GNode.create("QualifiedIdentifier", "xtc", "lang", "overlog", "runtime", "Marshaller"),
        null));
    javaAST.add(
      GNode.create("ImportDeclaration", null,
                   GNode.create("QualifiedIdentifier", "xtc", "lang", "overlog", "runtime", "NetAddr"),
        null));
    javaAST.add(
      GNode.create("ImportDeclaration", null,
  ...
  private void addImportsToEventHandler(Node javaAST) {
    javaAST.add(
      GNode.create("ImportDeclaration", null,
         GNode.create("QualifiedIdentifier", "xtc", "lang", "overlog", "runtime", "EventHandler"),
         null));
    javaAST.add(
      GNode.create("ImportDeclaration", null,
         GNode.create("QualifiedIdentifier", "xtc", "lang", "overlog", "runtime", "EventQueue"),
         null));
    javaAST.add(
      GNode.create("ImportDeclaration", null,
