...
/**
 * The driver for processesing the OCaml language.
 * 
 * @author Robert Soule
 * @version $Revision: 1.5 $
 */
public class FactoryFactory extends xtc.lang.FactoryFactory {
  /** Create a new driver for OCaml. */
  ...
  public Node parse(Reader in, File file) throws IOException, ParseException {
    FactoryParser parser = new xtc.lang.babble.boat.FactoryParser(in, file
  ...
  public static void main(String[] args) {
    new xtc.lang.babble.boat.FactoryFactory().run(args);
  }
}
