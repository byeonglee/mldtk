...
This document describes how to run the linear road benchmark application, Figure 4 (a) in the OOPSLA submission.
...
$ java xtc.lang.babble.watson.Watson -logLevel error -hostFile ./hosts.txt -user souler -templatePath ./watson/templates/ -toSystemS ./linearroad.bk

Copy the ml files into place.
