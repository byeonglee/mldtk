...
This document describes how to run the fine locking benchmark application, Figure 7 in the OOPSLA submission.

Step 1.  Put the Brooklet file in the proper location

$ cd src/xtc/lang/babble
$ cp locking/exp2/lock.bk .
...
$ cd MyApp/src
$ cp ../../locking/exp2/operators.ml .
$ cp ../../locking/exp2/Submit.h .
$ cp ../../locking/exp2/Submit.cpp .
