...
This document describes how to run the sawzall fission benchmark application, Figure 4 (c) in the OOPSLA submission.
...
$ cp benchmarks/sawzall_fission/origin-fast.bk ./origin-fast.bk 

The file run-parallel-sawzall.sh will apply the optimization. It expects that
