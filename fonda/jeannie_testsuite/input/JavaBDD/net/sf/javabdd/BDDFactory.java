 ...
 * 
 * @author John Whaley
 * @version $Id: BDDFactory.java,v 1.2 2007/07/25 21:25:37 pervasiv Exp $
 */
public abstract class BDDFactory {
    ...
    public static BDDFactory init(String bddpackage, int nodenum, int cachesize) {
        try {
            ...
            if (bddpackage.equals("jeannie"))
                return JeannieBuDDyFactory.init(nodenum, cachesize);
     ...
     */
    public GCStats gcstats = new GCStats();
